...
ucloud-model sdk test \
    --lang python3 \
    --template ../ucloud-api-model-v2/apisdk/lang/python/templates/testing.tpl \
    --output tests/test_services/test_set_255.py \
    --name 255
...
ucloud-model sdk test \
    --lang python3 \
    --template ../ucloud-api-model-v2/apisdk/lang/python/templates/testing.tpl \
    --output tests/test_services/test_set_867.py \
    --name 867
...
ucloud-model sdk test \
    --lang python3 \
    --template ../ucloud-api-model-v2/apisdk/lang/python/templates/testing.tpl \
    --output tests/test_services/test_set_3278.py \
    --name 3278

ucloud-model sdk test \
    --lang python3 \
    --template ../ucloud-api-model-v2/apisdk/lang/python/templates/testing.tpl \
    --output tests/test_services/test_set_3279.py \
    --name 3279
