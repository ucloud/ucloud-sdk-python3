...
def test_set_490(client: utest.Client, variables: dict):
...
def check_udb_instance_allowance_07(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "UseSSD": variables.get("UseSSD"),
        "Region": variables.get("Region"),
...
def create_udb_slave_10(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "UseSSD": variables.get("UseSSD"),
...
def describe_udb_instance_state_11(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
...
def update_udb_instance_slave_backup_switch_12(
...
def describe_udb_slave_or_secondary_instance_13(
    client: utest.Client, variables: dict
):
    d = {
        "Zone": variables.get("Zone"),
...
def restart_udb_instance_14(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("slave_dbid"),
...
def describe_udb_instance_state_15(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("slave_dbid"),
...
def stop_udb_instance_16(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("slave_dbid"),
...
def describe_udb_instance_state_19(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("slave_dbid"),
...
def stop_udb_instance_21(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("slave_dbid"),
...
def describe_udb_instance_22(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "Offset": 0,
...
def stop_udb_instance_23(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("DBId"),
...
def describe_udb_instance_24(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "Offset": 0,
...
def delete_udb_instance_26(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("slave_dbid"),
...
def delete_udb_instance_27(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Region": variables.get("Region"),
        "DBId": variables.get("DBId"),
