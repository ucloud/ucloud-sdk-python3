...
def test_set_242(client: utest.Client, variables: dict):
...
def describe_uredis_price_00(client: utest.Client, variables: dict):
    d = {
...
def describe_uredis_upgrade_price_04(client: utest.Client, variables: dict):
    d = {
        "Zone": variables.get("Zone"),
        "Size": 2,
        "Region": variables.get("Region"),
...
def resize_uredis_group_05(client: utest.Client, variables: dict):
    d = {
        "Size": 2,
        "Region": variables.get("Region"),
        "GroupId": variables.get("group_id"),
...
def delete_uredis_group_10(client: utest.Client, variables: dict):
    d = {
        "Region": variables.get("Region"),
        "GroupId": variables.get("group_id"),
    }
