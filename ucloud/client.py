...
class Client(client.Client):
    ...
    def nlb(self):
        ...
        return NLBClient(self._auto_config('nlb'), self.transport, self.middleware, self.logger)
    ...
    def sts(self):
        ...
        return STSClient(self._auto_config('sts'), self.transport, self.middleware, self.logger)
    ...
    def uaaa(self):
        ...
        return UAAAClient(self._auto_config('uaaa'), self.transport, self.middleware, self.logger)
    ...
    def uads(self):
        ...
        return UADSClient(self._auto_config('uads'), self.transport, self.middleware, self.logger)
    ...
    def uai_modelverse(self):
        ...
        return UAI_ModelverseClient(self._auto_config('uai_modelverse'), self.transport, self.middleware, self.logger)
    ...
    def uas(self):
        ...
        return UASClient(self._auto_config('uas'), self.transport, self.middleware, self.logger)
    ...
    def uclickhouse(self):
        ...
        return UClickhouseClient(self._auto_config('uclickhouse'), self.transport, self.middleware, self.logger)
    ...
    def ucompshare(self):
        ...
        return UCompShareClient(self._auto_config('ucompshare'), self.transport, self.middleware, self.logger)
    ...
    def udbproxy(self):
        ...
        return UDBProxyClient(self._auto_config('udbproxy'), self.transport, self.middleware, self.logger)
    ...
    def udi(self):
        ...
        return UDIClient(self._auto_config('udi'), self.transport, self.middleware, self.logger)
    ...
    def udns(self):
        ...
        return UDNSClient(self._auto_config('udns'), self.transport, self.middleware, self.logger)
    ...
    def ues(self):
        ...
        return UESClient(self._auto_config('ues'), self.transport, self.middleware, self.logger)
    ...
    def uhids(self):
        ...
        return UHIDSClient(self._auto_config('uhids'), self.transport, self.middleware, self.logger)
    ...
    def uhadoop(self):
        ...
        return UHadoopClient(self._auto_config('uhadoop'), self.transport, self.middleware, self.logger)
    ...
    def ulogservice(self):
        ...
        return ULogServiceClient(self._auto_config('ulogservice'), self.transport, self.middleware, self.logger)
    ...
    def umongodb(self):
        ...
        return UMongoDBClient(self._auto_config('umongodb'), self.transport, self.middleware, self.logger)
    ...
    def upfs(self):
        ...
        return UPFSClient(self._auto_config('upfs'), self.transport, self.middleware, self.logger)
    ...
    def upgsql(self):
        ...
        return UPgSQLClient(self._auto_config('upgsql'), self.transport, self.middleware, self.logger)
    ...
    def uphone(self):
        ...
        return UPhoneClient(self._auto_config('uphone'), self.transport, self.middleware, self.logger)
    ...
    def uslk(self):
        ...
        return USLKClient(self._auto_config('uslk'), self.transport, self.middleware, self.logger)
    ...
    def uwsc(self):
        ...
        return UWSCClient(self._auto_config('uwsc'), self.transport, self.middleware, self.logger)
    ...
    def ipv6gw(self):
        ...
        return ipv6gwClient(self._auto_config('ipv6gw'), self.transport, self.middleware, self.logger)
