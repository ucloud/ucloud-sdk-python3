...
class UPhoneInstanceSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UPhoneBandwidth': fields.Int(required=False, load_from='UPhoneBandwidth'), 
    
        'UPhoneId': fields.Str(required=True, load_from='UPhoneId'), 
    
        'UPhoneModelName': fields.Str(required=True, load_from='UPhoneModelName'), 
...
class UPhoneDetailInstanceSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UPhoneModelName': fields.Str(required=False, load_from='UPhoneModelName'), 
...
class ServerModelInstanceSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ServerModelName': fields.Str(required=False, load_from='ServerModelName'), 
    
        'ServerModelState': fields.Str(required=False, load_from='ServerModelState'), 
