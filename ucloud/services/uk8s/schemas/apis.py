...
class AddUK8SExistingUHostRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'DisableSchedule': fields.Bool(required=False, dump_to='DisableSchedule'), 
...
class AddUK8SUHostNodeRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'MinmalCpuPlatform': fields.Str(required=False, dump_to='MinmalCpuPlatform'), 
...
class AddUK8SUHostNodeResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Message': fields.Str(required=True, load_from='Message'), # Deprecated, will be removed at 1.0
    
        'NodeIds': fields.List(fields.Str(), required=False, load_from='NodeIds'), 
...
class CreateUK8SClusterV2RequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'ExternalApiServer': fields.Str(required=False, dump_to='ExternalApiServer'), 
        ...
        'KubeProxy': CreateUK8SClusterV2ParamKubeProxySchema(required=False, dump_to='KubeProxy'), 
    
        'Master': fields.List(CreateUK8SClusterV2ParamMasterSchema()), 
    
        'MasterBootDiskType': fields.Str(required=False, dump_to='MasterBootDiskType'), 
    
        'MasterCPU': fields.Int(required=True, dump_to='MasterCPU'), 
    
        'MasterDataDiskSize': fields.Int(required=False, dump_to='MasterDataDiskSize'), 
    
        'MasterDataDiskType': fields.Str(required=False, dump_to='MasterDataDiskType'), 
    
        'MasterIsolationGroup': fields.Str(required=False, dump_to='MasterIsolationGroup'), 
    
        'MasterMachineType': fields.Str(required=True, dump_to='MasterMachineType'), 
    
        'MasterMem': fields.Int(required=True, dump_to='MasterMem'), 
    
        'MasterMinmalCpuPlatform': fields.Str(required=False, dump_to='MasterMinmalCpuPlatform'), 
...
class DelUK8SClusterNodeV2RequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'ReleaseDataUDisk': fields.Bool(required=False, dump_to='ReleaseDataUDisk'), 
...
class DescribeUK8SClusterResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ExternalApiServer': fields.Str(required=False, load_from='ExternalApiServer'), 
    
        'KubeProxy':  models.KubeProxySchema(), 
    
        'MasterCount': fields.Int(required=True, load_from='MasterCount'), 
    
        'MasterList': fields.List(models.UhostInfoSchema(), required=False, load_from='MasterList'), 
    
        'MasterResourceStatus': fields.Str(required=False, load_from='MasterResourceStatus'), 
    
        'NodeCount': fields.Int(required=False, load_from='NodeCount'), 
    
        'NodeList': fields.List(models.UhostInfoSchema(), required=False, load_from='NodeList'), 
...
class DescribeUK8SImageResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ImageSet': fields.List(models.ImageInfoSchema(), required=False, load_from='ImageSet'), 
    
        'Message': fields.Str(required=True, load_from='Message'), 
    
        'PHostImageSet': fields.List(models.ImageInfoSchema(), required=False, load_from='PHostImageSet'), 
...
class DescribeUK8SNodeResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AllocatedPodCount': fields.Int(required=True, load_from='AllocatedPodCount'), 
    
        'Annotations': fields.List(fields.Str(), required=True, load_from='Annotations'), 
    
        'CPUCapacity': fields.Str(required=True, load_from='CPUCapacity'), 
    
        'CPULimits': fields.Str(required=True, load_from='CPULimits'), 
    
        'CPULimitsFraction': fields.Str(required=True, load_from='CPULimitsFraction'), 
    
        'CPURequests': fields.Str(required=True, load_from='CPURequests'), 
    
        'CPURequestsFraction': fields.Str(required=True, load_from='CPURequestsFraction'), 
    
        'Conditions': fields.List(models.K8SNodeConditionSchema(), required=True, load_from='Conditions'), 
    
        'ContainerImages': fields.List(fields.Str(), required=True, load_from='ContainerImages'), 
    
        'ContainerRuntimeVersion': fields.Str(required=True, load_from='ContainerRuntimeVersion'), 
    
        'CreationTimestamp': fields.Int(required=True, load_from='CreationTimestamp'), 
        ...
        'KubeProxyVersion': fields.Str(required=True, load_from='KubeProxyVersion'), 
        ...
        'MemoryLimitsFraction': fields.Str(required=True, load_from='MemoryLimitsFraction'), 
    
        'MemoryRequests': fields.Str(required=True, load_from='MemoryRequests'), 
    
        'MemoryRequestsFraction': fields.Str(required=True, load_from='MemoryRequestsFraction'), 
...
class ListUK8SClusterNodeV2ResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'NodeSet': fields.List(models.NodeInfoV2Schema(), required=True, load_from='NodeSet'), 
...
class ListUK8SClusterV2ResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ClusterSet': fields.List(models.ClusterSetSchema(), required=False, load_from='ClusterSet'), 
...
class ListUK8SNodeGroupResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'NodeGroupList': fields.List(models.NodeGroupSetSchema(), required=False, load_from='NodeGroupList'), 
