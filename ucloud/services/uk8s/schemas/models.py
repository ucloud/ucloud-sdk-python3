...
class K8SNodeConditionSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'LastTransitionTime': fields.Str(required=False, load_from='LastTransitionTime'), 
...
class UHostIPSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Default': fields.Str(required=False, load_from='Default'), # Deprecated, will be removed at 1.0
...
class ClusterSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ClusterLogInfo': fields.Str(required=False, load_from='ClusterLogInfo'), 
...
class NodeGroupSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'MinimalCpuPlatform': fields.Str(required=False, load_from='MinimalCpuPlatform'), 
