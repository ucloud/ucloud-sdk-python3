...
class ListUBillDetailResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Items': fields.List(models.BillDetailItemSchema(), required=True, load_from='Items'), 
...
class ListUBillOverviewResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Items': fields.List(models.BillOverviewItemSchema(), required=True, load_from='Items'), 
    
        'TotalCount': fields.Int(required=True, load_from='TotalCount'), 
    
        'TotalPaidAmount': fields.Str(required=False, load_from='TotalPaidAmount'), 
    
        'TotalPaidAmountReal': fields.Str(required=False, load_from='TotalPaidAmountReal'), 
    
        'TotalUnpaidAmount': fields.Str(required=False, load_from='TotalUnpaidAmount'), 
...
class ModifyAutoRenewFlagResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ResultSet': fields.List(models.ResultSetSchema(), required=True, load_from='ResultSet'), 
