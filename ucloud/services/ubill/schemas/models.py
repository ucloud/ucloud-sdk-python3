...
class AccountInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AmountAvailable': fields.Str(required=False, load_from='AmountAvailable'), 
...
class BillDetailItemSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ResourceTypeCode': fields.Int(required=True, load_from='ResourceTypeCode'), 
    
        'ShowHover': fields.Int(required=True, load_from='ShowHover'), 
    
        'StartTime': fields.Int(required=True, load_from='StartTime'), 
    
        'UserDisplayName': fields.Str(required=True, load_from='UserDisplayName'), 
...
class BillOverviewItemSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ProductCategory': fields.Str(required=False, load_from='ProductCategory'), 
    
        'ProjectName': fields.Str(required=False, load_from='ProjectName'), 
    
        'ResourceType': fields.Str(required=False, load_from='ResourceType'), 
    
        'ResourceTypeCode': fields.Int(required=False, load_from='ResourceTypeCode'), 
    
        'UserDisplayName': fields.Str(required=False, load_from='UserDisplayName'), 
