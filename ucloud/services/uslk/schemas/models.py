...
class RedirectRecordsSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ShortLinkDomain': fields.Str(required=True, load_from='ShortLinkDomain'), 
...
class ShortLinkSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ClickCountToday': fields.Int(required=True, load_from='ClickCountToday'), 
        ...
        'UniqueClickCount': fields.Int(required=True, load_from='UniqueClickCount'), 
    
        'UniqueClickCountToday': fields.Int(required=True, load_from='UniqueClickCountToday'), 
