...
class UDPNClient(Client):
    ...
    def modify_udpn_bandwidth(self, req: dict = None) -> dict:
        ...
        """
        req = apis.ModifyUDPNBandwidthRequestSchema().dumps(req or {})
        resp = self.invoke("ModifyUDPNBandwidth", req)
    ...
    def release_udpn(self, req: dict = None) -> dict:
        ...
        """
        req = apis.ReleaseUDPNRequestSchema().dumps(req or {})
        resp = self.invoke("ReleaseUDPN", req)
    ...
    def allocate_udpn(self, req: dict = None) -> dict:
        ...
        """
        req = apis.AllocateUDPNRequestSchema().dumps(req or {})
        resp = self.invoke("AllocateUDPN", req)
    ...
    def describe_udpn(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeUDPNRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUDPN", req)
    ...
    def get_udpn_line_list(self, req: dict = None) -> dict:
        ...
        :param Region: (Config) 地域。 参见 [地域和可用区列表](../summary/regionlist.html)
        """
        req = apis.GetUDPNLineListRequestSchema().dumps(req or {})
        resp = self.invoke("GetUDPNLineList", req)
    ...
    def get_udpn_price(self, req: dict = None) -> dict:
        ...
        """
        req = apis.GetUDPNPriceRequestSchema().dumps(req or {})
        resp = self.invoke("GetUDPNPrice", req)
    ...
    def get_udpn_upgrade_price(self, req: dict = None) -> dict:
        ...
        """
        req = apis.GetUDPNUpgradePriceRequestSchema().dumps(req or {})
        resp = self.invoke("GetUDPNUpgradePrice", req)
