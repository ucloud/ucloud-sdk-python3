...
class DescribeUDPNResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDPNDataSchema(), required=False, load_from='DataSet'), 
...
class GetUDPNLineListResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDPNLineSetSchema(), required=True, load_from='DataSet'), 
