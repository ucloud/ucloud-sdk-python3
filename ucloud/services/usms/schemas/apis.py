...
class CreateUSMSSignatureResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'SigContent': fields.Str(required=False, load_from='SigContent'), # Deprecated, will be removed at 1.0
...
class CreateUSMSTemplateRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'Region': fields.Str(required=False, dump_to='Region'), # Deprecated, will be removed at 1.0
        ...
        'UnsubscribeInfo': fields.Str(required=False, dump_to='UnsubscribeInfo'), 
...
class GetUSMSSendReceiptResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Data': fields.List(models.ReceiptPerSessionSchema(), required=True, load_from='Data'), 
...
class SendBatchUSMSMessageResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'FailContent': fields.List(models.BatchInfoSchema(), required=False, load_from='FailContent'), 
...
class UpdateUSMSSignatureRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'CertificateType': fields.Int(required=False, dump_to='CertificateType'), 
...
class UpdateUSMSTemplateRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'UnsubscribeInfo': fields.Str(required=False, dump_to='UnsubscribeInfo'), # Deprecated, will be removed at 1.0
