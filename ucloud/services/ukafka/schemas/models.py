...
class TopicPropertySchema(schema.ResponseSchema):
    """TopicProperty - topic 属性"""

    fields = {
        "BrokerSkewedPer": fields.Float(
            required=False, load_from="BrokerSkewedPer"
        ),
        "BrokerSpreadPer": fields.Float(
            required=False, load_from="BrokerSpreadPer"
        ),
        "NumOfBroker": fields.Int(required=False, load_from="NumOfBroker"),
        ...
        "PreferredReplicasPer": fields.Float(
            required=False, load_from="PreferredReplicasPer"
        ),
        "SumOfPartitionOffset": fields.Int(
            required=False, load_from="SumOfPartitionOffset"
        ),
        "SumTopicUsage": fields.Int(required=False, load_from="SumTopicUsage"),
...
class MessageStateSchema(schema.ResponseSchema):
    """MessageState - topic 消息动态"""

    fields = {
        "BytesInPerSec": fields.Float(
            required=False, load_from="BytesInPerSec"
        ),
        "BytesOutPerSec": fields.Float(
            required=False, load_from="BytesOutPerSec"
        ),
        "LastUpdateTime": fields.Int(
            required=False, load_from="LastUpdateTime"
        ),
        "MessagesInPerSec": fields.Float(
            required=False, load_from="MessagesInPerSec"
        ),
    }
