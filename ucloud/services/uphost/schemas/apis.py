...
class CreatePHostRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'Count': fields.Int(required=False, dump_to='Count'), # Deprecated, will be removed at 1.0
...
class CreatePHostResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'PHostId': fields.List(fields.Str(), required=False, load_from='PHostId'), 
...
class DescribeBaremetalMachineTypeResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'MachineTypes': fields.List(models.PHostCloudMachineTypeSetSchema(), required=False, load_from='MachineTypes'), 
...
class DescribePHostResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'PHostSet': fields.List(models.PHostSetSchema(), required=False, load_from='PHostSet'), 
...
class DescribePHostImageResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ImageSet': fields.List(models.PHostImageSetSchema(), required=False, load_from='ImageSet'), 
...
class DescribePHostMachineTypeResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'MachineTypes': fields.List(models.PHostMachineTypeSetSchema(), required=True, load_from='MachineTypes'), 
...
class DescribePHostTagsResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'TagSet': fields.List(models.PHostTagSetSchema(), required=False, load_from='TagSet'), 
...
class GetPHostPriceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'PriceSet': fields.List(models.PHostPriceSetSchema(), required=False, load_from='PriceSet'), 
