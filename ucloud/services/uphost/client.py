...
class UPHostClient(Client):
    ...
    def create_phost_image(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_baremetal_machine_type(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_phost_machine_type(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_phost_disk_upgrade_price(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def modify_phost_image_info(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def reset_phost_password(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def resize_phost_attached_disk(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def terminate_phost_image(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
