...
class CopyCustomImageRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'TargetImageDescription': fields.Str(required=False, dump_to='TargetImageDescription'), 
...
class CreateUHostInstanceParamNetworkInterfaceEIPSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'GlobalSSH': CreateUHostInstanceParamNetworkInterfaceEIPGlobalSSHSchema(required=False, dump_to='GlobalSSH'), # Deprecated, will be removed at 1.0
...
class CreateUHostInstanceParamNetworkInterfaceIPv6Schema(schema.RequestSchema):
    ...
    fields = {
        ...
        'Adress': fields.Str(required=False, dump_to='Adress'), # Deprecated, will be removed at 1.0
    
        'ShareBandwidthId': fields.Str(required=False, dump_to='ShareBandwidthId'), # Deprecated, will be removed at 1.0
...
class CreateUHostInstanceParamNetworkInterfaceSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'EIP': CreateUHostInstanceParamNetworkInterfaceEIPSchema(required=False, dump_to='EIP'), 
    
        'IPv6': CreateUHostInstanceParamNetworkInterfaceIPv6Schema(required=False, dump_to='IPv6'), # Deprecated, will be removed at 1.0
...
class CreateUHostInstanceParamVirtualGpuGPUVirtualGpuSchema(schema.RequestSchema):
...
class CreateUHostInstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'AutoDataDiskInit': fields.Str(required=False, dump_to='AutoDataDiskInit'), 
    
        'BootDiskSpace': fields.Int(required=False, dump_to='BootDiskSpace'), # Deprecated, will be removed at 1.0
        ...
        'DiskPassword': fields.Str(required=False, dump_to='DiskPassword'), # Deprecated, will be removed at 1.0
    
        'DiskSpace': fields.Int(required=False, dump_to='DiskSpace'), # Deprecated, will be removed at 1.0
    
        'Disks': fields.List(CreateUHostInstanceParamDisksSchema()), 
    
        'Features': CreateUHostInstanceParamFeaturesSchema(required=False, dump_to='Features'), 
    
        'GPU': fields.Int(required=False, dump_to='GPU'), 
    
        'GpuType': fields.Str(required=False, dump_to='GpuType'), 
    
        'HostIp': fields.Str(required=False, dump_to='HostIp'), # Deprecated, will be removed at 1.0
    
        'HostType': fields.Str(required=False, dump_to='HostType'), # Deprecated, will be removed at 1.0
    
        'HotplugFeature': fields.Bool(required=False, dump_to='HotplugFeature'), 
    
        'HpcEnhanced': fields.Bool(required=False, dump_to='HpcEnhanced'), # Deprecated, will be removed at 1.0
    
        'ImageId': fields.Str(required=True, dump_to='ImageId'), 
    
        'InstallAgent': fields.Str(required=False, dump_to='InstallAgent'), # Deprecated, will be removed at 1.0
    
        'IsolationGroup': fields.Str(required=False, dump_to='IsolationGroup'), 
    
        'KeyPair': fields.Str(required=False, dump_to='KeyPair'), # Deprecated, will be removed at 1.0
        ...
        'NetworkId': fields.Str(required=False, dump_to='NetworkId'), # Deprecated, will be removed at 1.0
    
        'NetworkInterface': fields.List(CreateUHostInstanceParamNetworkInterfaceSchema()), 
    
        'Password': fields.Base64(required=False, dump_to='Password'), 
    
        'PrivateIp': fields.List(fields.Str()), 
    
        'PrivateMac': fields.Str(required=False, dump_to='PrivateMac'), # Deprecated, will be removed at 1.0
        ...
        'ResourceType': fields.Str(required=False, dump_to='ResourceType'), # Deprecated, will be removed at 1.0
    
        'RestrictMode': fields.Str(required=False, dump_to='RestrictMode'), # Deprecated, will be removed at 1.0
    
        'SecurityGroupId': fields.Str(required=False, dump_to='SecurityGroupId'), 
    
        'SetId': fields.Int(required=False, dump_to='SetId'), # Deprecated, will be removed at 1.0
    
        'StorageType': fields.Str(required=False, dump_to='StorageType'), # Deprecated, will be removed at 1.0
    
        'SubnetId': fields.Str(required=False, dump_to='SubnetId'), 
    
        'Tag': fields.Str(required=False, dump_to='Tag'), 
    
        'TimemachineFeature': fields.Str(required=False, dump_to='TimemachineFeature'), # Deprecated, will be removed at 1.0
    
        'UHostType': fields.Str(required=False, dump_to='UHostType'), 
    
        'UserData': fields.Str(required=False, dump_to='UserData'), 
    
        'UserDataScript': fields.Str(required=False, dump_to='UserDataScript'), # Deprecated, will be removed at 1.0
...
class DescribeAvailableInstanceTypesResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AvailableInstanceTypes': fields.List(models.AvailableInstanceTypesSchema(), required=True, load_from='AvailableInstanceTypes'), 
...
class DescribeImageResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ImageSet': fields.List(models.UHostImageSetSchema(), required=False, load_from='ImageSet'), 
...
class DescribeIsolationGroupResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'IsolationGroupSet': fields.List(models.IsolationGroupSchema(), required=False, load_from='IsolationGroupSet'), 
...
class DescribeUHostInstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'LifeCycle': fields.Int(required=False, dump_to='LifeCycle'), # Deprecated, will be removed at 1.0
        ...
        'UDiskIdForAttachment': fields.Str(required=False, dump_to='UDiskIdForAttachment'), 
...
class DescribeUHostInstanceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UHostSet': fields.List(models.UHostInstanceSetSchema(), required=True, load_from='UHostSet'), 
...
class DescribeUHostInstanceSnapshotResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'SnapshotSet': fields.List(models.UHostSnapshotSetSchema(), required=False, load_from='SnapshotSet'), 
...
class DescribeUHostKeyPairsRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'KeyPairFingerPrint': fields.Str(required=False, dump_to='KeyPairFingerPrint'), 
...
class DescribeUHostKeyPairsResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'KeyPairs': fields.List(models.KeyPairDescSchema(), required=True, load_from='KeyPairs'), 
...
class DescribeUHostTagsResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'TagSet': fields.List(models.UHostTagSetSchema(), required=False, load_from='TagSet'), 
...
class GetUHostInstancePriceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'PriceSet': fields.List(models.UHostPriceSetSchema(), required=False, load_from='PriceSet'), 
...
class GetUHostInstanceVncInfoResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UhostId': fields.Str(required=False, load_from='UhostId'), # Deprecated, will be removed at 1.0
...
class ImportUHostKeyPairsResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'KeyPairFingerPrint': fields.Str(required=False, load_from='KeyPairFingerPrint'), 
...
class ModifyUHostIPRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'PresentIpAddress': fields.Str(required=True, dump_to='PresentIpAddress'), 
...
class ReinstallUHostInstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'DNSServers': fields.List(fields.Str()), # Deprecated, will be removed at 1.0
        ...
        'ResourceType': fields.Int(required=False, dump_to='ResourceType'), # Deprecated, will be removed at 1.0
...
class TerminateCustomImageRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'Zone': fields.Str(required=False, dump_to='Zone'), # Deprecated, will be removed at 1.0
...
class TerminateUHostInstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'Destroy': fields.Int(required=False, dump_to='Destroy'), # Deprecated, will be removed at 1.0
