...
class CubeClient(Client):
    ...
    def create_cube_deployment(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def create_cube_pod(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
        """ CreateCubePod - 创建Pod
    ...
    def delete_cube_deployment(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def delete_cube_pod(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
        """ DeleteCubePod - 删除Pod
    ...
    def get_cube_deployment(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_cube_exec_token(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_cube_extend_info(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_cube_metrics(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_cube_price(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_cube_token(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def list_cube_deployment(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def list_cube_pod(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def modify_cube_extend_info(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def modify_cube_tag(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def reboot_cube_pod(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def renew_cube_pod(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
        """ RenewCubePod - 更新Pod
    ...
    def update_cube_deployment(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
