...
class GetCubeExtendInfoResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ExtendInfo': fields.List(models.CubeExtendInfoSchema(), required=True, load_from='ExtendInfo'), 
...
class GetCubeMetricsResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSets': fields.List(models.MetricDataSetSchema(), required=False, load_from='DataSets'), 
...
class ListCubeDeploymentResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Deployments': fields.List(fields.Str(), required=True, load_from='Deployments'), 
