...
class UMemClient(Client):
    def __init__(self, config: dict, transport=None, middleware=None):
        super(UMemClient, self).__init__(config, transport, middleware)
    ...
    def create_uredis_group(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
        ...
        :param ConfigId: (Optional) 配置ID,目前仅支持默认配置id 默认创建3.0版本 配置id:"03f58ca9-b64d-4bdd-abc7-c6b9a46fd801"，3.0版本配置ID：03f58ca9-b64d-4bdd-abc7-c6b9a46fd8013.2版本配置ID：3e45ac48-f8a2-a9q2-261d-l342dab130gf4.0版本配置ID：6c9298a3-9d7f-428c-b1d0-e87ab3b8a1ea,从备份创建为必传项
