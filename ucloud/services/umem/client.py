...
class UMemClient(Client):
    ...
    def describe_umem_space(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeUMemSpaceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUMemSpace", req)
    ...
    def describe_uredis_backup(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeURedisBackupRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeURedisBackup", req)
    ...
    def describe_uredis_price(self, req: dict = None) -> dict:
        ...
        :param Type: (Optional) 
        """
        req = apis.DescribeURedisPriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeURedisPrice", req)
    ...
    def resize_udredis_space(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.ResizeUDredisSpaceRequestSchema().dumps(req or {})
        resp = self.invoke("ResizeUDredisSpace", req)
    ...
    def create_uredis_group(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CreateURedisGroupRequestSchema().dumps(req or {})
        resp = self.invoke("CreateURedisGroup", req)
    ...
    def describe_umem_upgrade_price(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DescribeUMemUpgradePriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUMemUpgradePrice", req)
    ...
    def describe_uredis_upgrade_price(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DescribeURedisUpgradePriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeURedisUpgradePrice", req)
    ...
    def get_umem_space_state(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.GetUMemSpaceStateRequestSchema().dumps(req or {})
        resp = self.invoke("GetUMemSpaceState", req)
    ...
    def resize_uredis_group(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.ResizeURedisGroupRequestSchema().dumps(req or {})
        resp = self.invoke("ResizeURedisGroup", req)
    ...
    def create_umem_space(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.CreateUMemSpaceRequestSchema().dumps(req or {})
        resp = self.invoke("CreateUMemSpace", req)
    ...
    def create_umem_cache_group(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.CreateUMemcacheGroupRequestSchema().dumps(req or {})
        resp = self.invoke("CreateUMemcacheGroup", req)
    ...
    def delete_umem_space(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DeleteUMemSpaceRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteUMemSpace", req)
    ...
    def describe_umem_cache_price(self, req: dict = None) -> dict:
        ...
        :param Type: (Optional) 空间类型:single(无热备),double(热备)(默认: double)
        """
        req = apis.DescribeUMemcachePriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUMemcachePrice", req)
    ...
    def modify_umem_space_name(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.ModifyUMemSpaceNameRequestSchema().dumps(req or {})
        resp = self.invoke("ModifyUMemSpaceName", req)
    ...
    def describe_uredis_backup_url(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DescribeURedisBackupURLRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeURedisBackupURL", req)
    ...
    def describe_uredis_group(self, req: dict = None) -> dict:
        ...
        :param Offset: (Optional) 分页显示的起始偏移, 默认值为0
        """
        req = apis.DescribeURedisGroupRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeURedisGroup", req)
    ...
    def modify_uredis_group_name(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.ModifyURedisGroupNameRequestSchema().dumps(req or {})
        resp = self.invoke("ModifyURedisGroupName", req)
    ...
    def delete_umem_cache_group(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DeleteUMemcacheGroupRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteUMemcacheGroup", req)
    ...
    def delete_uredis_group(self, req: dict = None) -> dict:
        ...
        :param GroupId: (Required) 组ID
        """
        req = apis.DeleteURedisGroupRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteURedisGroup", req)
    ...
    def describe_umem_price(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeUMemPriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUMemPrice", req)
    ...
    def describe_umem_cache_group(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DescribeUMemcacheGroupRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUMemcacheGroup", req)
    ...
    def describe_umem_cache_upgrade_price(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DescribeUMemcacheUpgradePriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUMemcacheUpgradePrice", req)
    ...
    def resize_umem_space(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.ResizeUMemSpaceRequestSchema().dumps(req or {})
        resp = self.invoke("ResizeUMemSpace", req)
    ...
    def restart_umem_cache_group(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.RestartUMemcacheGroupRequestSchema().dumps(req or {})
        resp = self.invoke("RestartUMemcacheGroup", req)
