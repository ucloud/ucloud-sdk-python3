...
class CharacterSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'CharacterDescription': fields.Str(required=True, load_from='CharacterDescription'), 
...
class MemberInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DefultProjectId': fields.Str(required=True, load_from='DefultProjectId'), 
        ...
        'PasswordPolicyDate': fields.Int(required=True, load_from='PasswordPolicyDate'), 
...
class NetworkMaskSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'LoginNetworkMask': fields.Str(required=True, load_from='LoginNetworkMask'), 
