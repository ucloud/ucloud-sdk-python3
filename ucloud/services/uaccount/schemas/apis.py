...
class CreateCharacterRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'CharacterDescription': fields.Str(required=False, dump_to='CharacterDescription'), 
...
class DescribeCharacterListResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'CharacterSet': fields.List(models.CharacterSetSchema(), required=True, load_from='CharacterSet'), 
...
class DescribeMemberListResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'MemberSet': fields.List(models.MemberInfoSchema(), required=True, load_from='MemberSet'), 
...
class GetProjectListResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ProjectSet': fields.List(models.ProjectListInfoSchema(), required=True, load_from='ProjectSet'), 
...
class GetRegionResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Regions': fields.List(models.RegionInfoSchema(), required=False, load_from='Regions'), 
...
class GetUserInfoResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UserInfoSchema(), required=True, load_from='DataSet'), 
...
class SetNetworkMaskRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'LoginNetworkMask': fields.Str(required=False, dump_to='LoginNetworkMask'), 
