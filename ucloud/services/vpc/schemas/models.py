...
class NetworkInterfaceInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AttachInstanceId': fields.Str(required=False, load_from='AttachInstanceId'), 
...
class NatGatewayDataSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'IsSnatpoolEnabled': fields.Str(required=True, load_from='IsSnatpoolEnabled'), 
...
class TargetResourceInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'SubResourceName': fields.Str(required=True, load_from='SubResourceName'), 
    
        'SubResourceType': fields.Int(required=True, load_from='SubResourceType'), 
...
class AclEntryInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'TargetResourceCount': fields.Int(required=False, load_from='TargetResourceCount'), 
...
class UNIQuotaInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'PrivateIpCount': fields.Int(required=False, load_from='PrivateIpCount'), 
    
        'PrivateIpQuota': fields.Int(required=False, load_from='PrivateIpQuota'), 
...
class SubnetResourceSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'IPv6Address': fields.Str(required=False, load_from='IPv6Address'), # Deprecated, will be removed at 1.0
        ...
        'SubResourceId': fields.Str(required=False, load_from='SubResourceId'), # Deprecated, will be removed at 1.0
    
        'SubResourceName': fields.Str(required=False, load_from='SubResourceName'), # Deprecated, will be removed at 1.0
    
        'SubResourceType': fields.Str(required=False, load_from='SubResourceType'), # Deprecated, will be removed at 1.0
...
class DescribeWhiteListResourceObjectIPInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'SubResourceType': fields.Str(required=True, load_from='SubResourceType'), 
...
class NatGWWhitelistDataSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ObjectIPInfo': fields.List(DescribeWhiteListResourceObjectIPInfoSchema()), 
