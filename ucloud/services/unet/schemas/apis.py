...
class AllocateEIPResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'EIPSet': fields.List(models.UnetAllocateEIPSetSchema(), required=False, load_from='EIPSet'), 
...
class AllocateShareBandwidthRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'BwType': fields.Str(required=False, dump_to='BwType'), # Deprecated, will be removed at 1.0
        ...
        'ShareBandwidthGuarantee': fields.Int(required=False, dump_to='ShareBandwidthGuarantee'), # Deprecated, will be removed at 1.0
...
class CreateBandwidthPackageRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'ProjectId': fields.Str(required=False, dump_to='ProjectId'), # Deprecated, will be removed at 1.0
...
class DescribeBandwidthPackageResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSets': fields.List(models.UnetBandwidthPackageSetSchema(), required=False, load_from='DataSets'), 
...
class DescribeBandwidthUsageResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'EIPSet': fields.List(models.UnetBandwidthUsageEIPSetSchema(), required=False, load_from='EIPSet'), 
...
class DescribeEIPResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'EIPSet': fields.List(models.UnetEIPSetSchema(), required=False, load_from='EIPSet'), 
...
class DescribeFirewallResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.FirewallDataSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeFirewallResourceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ResourceSet': fields.List(models.ResourceSetSchema(), required=False, load_from='ResourceSet'), 
...
class DescribeShareBandwidthResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UnetShareBandwidthSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeShareBandwidthPriceRequestSchema(schema.RequestSchema):
...
class DescribeShareBandwidthPriceResponseSchema(schema.ResponseSchema):
    """ DescribeShareBandwidthPrice - 获取共享带宽价格
    """
    fields = {
...
class DescribeShareBandwidthUpdatePriceRequestSchema(schema.RequestSchema):
...
class DescribeShareBandwidthUpdatePriceResponseSchema(schema.ResponseSchema):
    """ DescribeShareBandwidthUpdatePrice - 获取共享带宽升级价格
    """
    fields = {
...
class GetEIPPayModeResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'EIPPayMode': fields.List(models.EIPPayModeSetSchema(), required=False, load_from='EIPPayMode'), 
...
class GetEIPPriceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'PriceSet': fields.List(models.EIPPriceDetailSetSchema(), required=False, load_from='PriceSet'), 
...
class GetThroughputDailyBillingInfoResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Stats': fields.List(models.ThroughputDailyBillingInfoSchema(), required=False, load_from='Stats'), 
