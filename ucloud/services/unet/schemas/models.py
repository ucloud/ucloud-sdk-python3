...
class UnetEIPResourceSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ResourceId': fields.Str(required=False, load_from='ResourceId'), # Deprecated, will be removed at 1.0
...
class ShareBandwidthSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ShareBandwidthName': fields.Str(required=False, load_from='ShareBandwidthName'), 
...
class UnetShareBandwidthSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'BandwidthGuarantee': fields.Int(required=False, load_from='BandwidthGuarantee'), # Deprecated, will be removed at 1.0
        ...
        'PostPayStartTime': fields.Int(required=False, load_from='PostPayStartTime'), # Deprecated, will be removed at 1.0
