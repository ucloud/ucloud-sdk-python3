...
class UNetClient(Client):
    ...
    def allocate_share_bandwidth(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def associate_eip_with_share_bandwidth(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def create_bandwidth_package(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def delete_bandwidth_package(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_bandwidth_package(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_bandwidth_usage(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_firewall_resource(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_share_bandwidth(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_share_bandwidth_price(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_share_bandwidth_update_price(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
        ...
        **Response**
        ...
        return apis.DescribeShareBandwidthUpdatePriceResponseSchema().loads(resp)
    ...
    def disassociate_eip_with_share_bandwidth(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def disassociate_firewall(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_eip_upgrade_price(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def get_throughput_daily_billing_info(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def release_share_bandwidth(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def resize_share_bandwidth(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def update_firewall_attribute(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
