...
class CreateListenerParamHealthCheckConfigSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        "DownCounts": fields.Int(required=False, dump_to="DownCounts"),
        "Enabled": fields.Bool(required=False, dump_to="Enabled"),
        "HTTPVersion": fields.Str(required=False, dump_to="HTTPVersion"),
        "Interval": fields.Int(required=False, dump_to="Interval"),
...
class CreateListenerRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        "TargetProtocol": fields.Str(required=False, dump_to="TargetProtocol"),
    }
...
class CreateRuleParamRuleActionsSchema(schema.RequestSchema):
    ...
    fields = {
        "BackendConnectionConfig": CreateRuleParamRuleActionsBackendConnectionConfigSchema(
        ...
        "ProxyBufferingConfig": CreateRuleParamRuleActionsProxyBufferingConfigSchema(
