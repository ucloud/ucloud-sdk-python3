...
class AllocateBackendBatchResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'BackendSet': fields.List(models.BackendSetSchema(), required=False, load_from='BackendSet'), 
...
class CreateSecurityPolicyRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'SecurityPolicyName': fields.Str(required=True, dump_to='SecurityPolicyName'), 
...
class CreateSecurityPolicyResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'SecurityPolicyId': fields.Str(required=True, load_from='SecurityPolicyId'), 
...
class CreateULBRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'IPVersion': fields.Str(required=False, dump_to='IPVersion'), # Deprecated, will be removed at 1.0
        ...
        'PrivateIp': fields.Str(required=False, dump_to='PrivateIp'), # Deprecated, will be removed at 1.0
...
class CreateVServerRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'EnableCompression': fields.Int(required=False, dump_to='EnableCompression'), 
        ...
        'SecurityPolicyId': fields.Str(required=False, dump_to='SecurityPolicyId'), 
...
class DeletePolicyRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'GroupId': fields.Str(required=False, dump_to='GroupId'), # Deprecated, will be removed at 1.0
...
class DeleteSecurityPolicyRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'SecurityPolicyId': fields.Str(required=True, dump_to='SecurityPolicyId'), 
...
class DescribeSSLResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.ULBSSLSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeSecurityPoliciesResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.SecurityPolicySchema(), required=False, load_from='DataSet'), 
...
class DescribeSupportCiphersResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.TLSAndCiphersSchema(), required=False, load_from='DataSet'), 
...
class DescribeULBResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.ULBSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeULBSimpleResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.ULBSimpleSetSchema(), required=True, load_from='DataSet'), 
...
class DescribeVServerResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.ULBVServerSetSchema(), required=False, load_from='DataSet'), 
...
class UpdatePolicyRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'DomainMatchMode': fields.Str(required=False, dump_to='DomainMatchMode'), 
...
class UpdatePolicyResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'PolicyId': fields.Str(required=False, load_from='PolicyId'), # Deprecated, will be removed at 1.0
...
class UpdateSecurityPolicyRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'SecurityPolicyName': fields.Str(required=False, dump_to='SecurityPolicyName'), 
...
class UpdateVServerAttributeRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'Protocol': fields.Str(required=False, dump_to='Protocol'), # Deprecated, will be removed at 1.0
