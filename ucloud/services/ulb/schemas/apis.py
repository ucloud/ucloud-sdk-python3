...
class CreatePolicyGroupRequestSchema(schema.RequestSchema):
    """CreatePolicyGroup - 创建内容转发策略组"""

    fields = {
        "GroupName": fields.Str(required=False, dump_to="GroupName"),
        "Region": fields.Str(required=True, dump_to="Region"),
    }


class CreatePolicyGroupResponseSchema(schema.ResponseSchema):
    """CreatePolicyGroup - 创建内容转发策略组"""
...
class DeletePolicyGroupRequestSchema(schema.RequestSchema):
...
class DeletePolicyGroupResponseSchema(schema.ResponseSchema):
    """DeletePolicyGroup - 删除内容转发策略组"""
...
class DescribePolicyGroupRequestSchema(schema.RequestSchema):
...
class DescribePolicyGroupResponseSchema(schema.ResponseSchema):
    """DescribePolicyGroup - 获取内容转发组详细信息"""

    fields = {
        "DataSet": fields.List(
            models.UlbPolicyGroupSetSchema(),
            required=False,
            load_from="DataSet",
        ),
    }
...
class UpdatePolicyGroupAttributeRequestSchema(schema.RequestSchema):
...
class UpdatePolicyGroupAttributeResponseSchema(schema.ResponseSchema):
    """UpdatePolicyGroupAttribute - 更新内容转发策略组属性"""
