...
class SecurityPolicySchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'SecurityPolicyName': fields.Str(required=True, load_from='SecurityPolicyName'), 
    
        'SecurityPolicyType': fields.Int(required=True, load_from='SecurityPolicyType'), 
...
class BindSecurityPolicySchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'SecurityPolicyId': fields.Str(required=False, load_from='SecurityPolicyId'), 
    
        'SecurityPolicyName': fields.Str(required=False, load_from='SecurityPolicyName'), 
    
        'SecurityPolicyType': fields.Int(required=False, load_from='SecurityPolicyType'), 
...
class ULBPolicySetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DomainMatchMode': fields.Str(required=False, load_from='DomainMatchMode'), 
...
class ULBVServerSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'EnableCompression': fields.Int(required=False, load_from='EnableCompression'), 
        ...
        'PersistenceType': fields.Str(required=True, load_from='PersistenceType'), 
...
class ULBSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ExpireTime': fields.Int(required=False, load_from='ExpireTime'), # Deprecated, will be removed at 1.0
        ...
        'Resource': fields.List(fields.Str()), # Deprecated, will be removed at 1.0
        ...
        'ULBName': fields.Str(required=False, load_from='ULBName'), # Deprecated, will be removed at 1.0
