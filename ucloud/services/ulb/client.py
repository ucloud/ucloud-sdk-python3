...
class ULBClient(Client):
    ...
    def bind_ssl(self, req: dict = None) -> dict:
        ...
        """
        req = apis.BindSSLRequestSchema().dumps(req or {})
        resp = self.invoke("BindSSL", req)
    ...
    def delete_vserver(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DeleteVServerRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteVServer", req)
    ...
    def describe_vserver(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeVServerRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeVServer", req)
    ...
    def unbind_ssl(self, req: dict = None) -> dict:
        ...
        :param VServerId: (Required) 所绑定VServer实例ID
        """
        req = apis.UnbindSSLRequestSchema().dumps(req or {})
        resp = self.invoke("UnbindSSL", req)
    ...
    def update_backend_attribute(self, req: dict = None) -> dict:
        ...
        """
        req = apis.UpdateBackendAttributeRequestSchema().dumps(req or {})
        resp = self.invoke("UpdateBackendAttribute", req)
    ...
    def update_vserver_attribute(self, req: dict = None) -> dict:
        ...
        """
        req = apis.UpdateVServerAttributeRequestSchema().dumps(req or {})
        resp = self.invoke("UpdateVServerAttribute", req)
    ...
    def allocate_backend_batch(self, req: dict = None) -> dict:
        ...
        """
        req = apis.AllocateBackendBatchRequestSchema().dumps(req or {})
        resp = self.invoke("AllocateBackendBatch", req)
    ...
    def create_policy(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CreatePolicyRequestSchema().dumps(req or {})
        resp = self.invoke("CreatePolicy", req)
    ...
    def create_ssl(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CreateSSLRequestSchema().dumps(req or {})
        resp = self.invoke("CreateSSL", req)
    ...
    def delete_ulb(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DeleteULBRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteULB", req)
    ...
    def update_ulb_attribute(self, req: dict = None) -> dict:
        ...
        """
        req = apis.UpdateULBAttributeRequestSchema().dumps(req or {})
        resp = self.invoke("UpdateULBAttribute", req)
    ...
    def describe_ssl(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeSSLRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeSSL", req)
    ...
    def describe_ulb(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeULBRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeULB", req)
    ...
    def release_backend(self, req: dict = None) -> dict:
        ...
        :param ULBId: (Required) 负载均衡实例的ID
        """
        req = apis.ReleaseBackendRequestSchema().dumps(req or {})
        resp = self.invoke("ReleaseBackend", req)
    ...
    def update_policy(self, req: dict = None) -> dict:
        ...
        :param Type: (Optional) 内容转发匹配字段的类型
        """
        req = apis.UpdatePolicyRequestSchema().dumps(req or {})
        resp = self.invoke("UpdatePolicy", req)
    ...
    def allocate_backend(self, req: dict = None) -> dict:
        ...
        :param Weight: (Optional) 所添加的后端RS权重（在加权轮询算法下有效），取值范围[0-100]，默认为1
        """
        req = apis.AllocateBackendRequestSchema().dumps(req or {})
        resp = self.invoke("AllocateBackend", req)
    ...
    def create_ulb(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CreateULBRequestSchema().dumps(req or {})
        resp = self.invoke("CreateULB", req)
    ...
    def create_vserver(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CreateVServerRequestSchema().dumps(req or {})
        resp = self.invoke("CreateVServer", req)
    ...
    def delete_policy(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DeletePolicyRequestSchema().dumps(req or {})
        resp = self.invoke("DeletePolicy", req)
    ...
    def delete_ssl(self, req: dict = None) -> dict:
        ...
        :param SSLId: (Required) SSL证书的ID
        """
        req = apis.DeleteSSLRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteSSL", req)
