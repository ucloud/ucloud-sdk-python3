...
class ULBClient(Client):
    ...
    def create_policy_group(
        ...
        **Request**
        ...
        - **Region** (str) - (Config) 地域。 参见  `地域和可用区列表 <https://docs.ucloud.cn/api/summary/regionlist.html>`_
        - **GroupName** (str) - 内容转发策略组名称，默认为空

        **Response**

        - **GroupId** (str) - 内容转发策略组的Id
        ...
        req and d.update(req)
        d = apis.CreatePolicyGroupRequestSchema().dumps(d)

        # build options
        kwargs["max_retries"] = 0  # ignore retry when api is not idempotent

        resp = self.invoke("CreatePolicyGroup", d, **kwargs)
        return apis.CreatePolicyGroupResponseSchema().loads(resp)
    ...
    def create_vserver(
        ...
        **Request**
        ...
        - **MonitorType** (str) - 健康检查类型，枚举值：Port -> 端口检查；Path -> 路径检查；Ping -> Ping探测，请求代理型默认值为Port，其中TCP协议仅支持Port，其他协议支持Port和Path;报文转发型TCP协议仅支持Port，UDP协议支持Ping和Port，默认值为Ping
    ...
    def delete_policy_group(
        ...
        **Request**
        ...
        - **Region** (str) - (Config) 地域。 参见  `地域和可用区列表 <https://docs.ucloud.cn/api/summary/regionlist.html>`_
        - **GroupId** (str) - (Required) 内容转发策略组ID
        ...
        **Response**
        ...
        req and d.update(req)
        d = apis.DeletePolicyGroupRequestSchema().dumps(d)

        resp = self.invoke("DeletePolicyGroup", d, **kwargs)
        return apis.DeletePolicyGroupResponseSchema().loads(resp)
    ...
    def describe_policy_group(
        ...
        **Response**
        ...
        - **DataSet** (list) - 见 **UlbPolicyGroupSet** 模型定义
        ...
        **UlbPolicyBackendSet**
        ...
        - **PrivateIP** (str) - 后端资源实例的内网IP

        **UlbPolicySet**

        - **BackendSet** (list) - 见 **UlbPolicyBackendSet** 模型定义
        - **Match** (str) - 内容转发匹配字段
        - **PolicyId** (str) - 内容转发策略组ID
        - **Type** (str) - 内容转发匹配字段的类型，当前只支持按域名转发。枚举值为： Domain，按域名转发
        - **VServerId** (str) - 内容转发策略组ID应用的VServer实例的ID

        **UlbPolicyGroupSet**

        - **GroupId** (str) - 内容转发策略组ID
        - **GroupName** (str) - 内容转发策略组名称
        ...
        req and d.update(req)
        d = apis.DescribePolicyGroupRequestSchema().dumps(d)

        resp = self.invoke("DescribePolicyGroup", d, **kwargs)
        return apis.DescribePolicyGroupResponseSchema().loads(resp)
    ...
    def describe_ulb(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
        ...
        **ULBVServerSet**
        ...
        - **MonitorType** (str) - 健康检查类型，枚举值：Port -> 端口检查；Path -> 路径检查；Ping -> Ping探测， 请求代理型默认值为Port，其中TCP协议仅支持Port，其他协议支持Port和Path; 报文转发型TCP协议仅支持Port，UDP协议支持Ping和Port
    ...
    def update_policy_group_attribute(
        self, req: typing.Optional[dict] = None, **kwargs
    ) -> dict:
        ...
        **Response**
        ...
        req and d.update(req)
        d = apis.UpdatePolicyGroupAttributeRequestSchema().dumps(d)

        resp = self.invoke("UpdatePolicyGroupAttribute", d, **kwargs)
        return apis.UpdatePolicyGroupAttributeResponseSchema().loads(resp)
