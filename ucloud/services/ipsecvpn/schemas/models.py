...
class RemoteVPNGatewayDataSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ActiveTunnels': fields.Str(required=False, load_from='ActiveTunnels'), # Deprecated, will be removed at 1.0
    
        'CreateTime': fields.Int(required=False, load_from='CreateTime'), 
    
        'Remark': fields.Str(required=False, load_from='Remark'), 
    
        'RemoteVPNGatewayAddr': fields.Str(required=False, load_from='RemoteVPNGatewayAddr'), 
    
        'RemoteVPNGatewayId': fields.Str(required=False, load_from='RemoteVPNGatewayId'), 
    
        'RemoteVPNGatewayName': fields.Str(required=False, load_from='RemoteVPNGatewayName'), 
...
class VPNGatewayDataSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'VPNGatewayName': fields.Str(required=False, load_from='VPNGatewayName'), 
...
class IPSecDataSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'IPSecAuthenticationAlgorithm': fields.Str(required=False, load_from='IPSecAuthenticationAlgorithm'), 
    
        'IPSecEncryptionAlgorithm': fields.Str(required=False, load_from='IPSecEncryptionAlgorithm'), 
    
        'IPSecLocalSubnetIds': fields.List(fields.Str()), 
    
        'IPSecPFSDhGroup': fields.Str(required=False, load_from='IPSecPFSDhGroup'), 
    
        'IPSecProtocol': fields.Str(required=False, load_from='IPSecProtocol'), 
    
        'IPSecRemoteSubnets': fields.List(fields.Str()), 
    
        'IPSecSALifetime': fields.Str(required=False, load_from='IPSecSALifetime'), 
    
        'IPSecSALifetimeBytes': fields.Str(required=False, load_from='IPSecSALifetimeBytes'), 
...
class IKEDataSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'IKEAuthenticationAlgorithm': fields.Str(required=False, load_from='IKEAuthenticationAlgorithm'), 
    
        'IKEDhGroup': fields.Str(required=False, load_from='IKEDhGroup'), 
    
        'IKEEncryptionAlgorithm': fields.Str(required=False, load_from='IKEEncryptionAlgorithm'), 
    
        'IKEExchangeMode': fields.Str(required=False, load_from='IKEExchangeMode'), 
    
        'IKELocalId': fields.Str(required=False, load_from='IKELocalId'), 
    
        'IKEPreSharedKey': fields.Str(required=False, load_from='IKEPreSharedKey'), 
