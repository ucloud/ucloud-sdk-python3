...
class CacheConfSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'FollowOriginRule': fields.Bool(required=False, load_from='FollowOriginRule'), 
    
        'HttpCodePattern': fields.Str(required=False, load_from='HttpCodePattern'), 
...
class DomainInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'HttpsStatusAbroad': fields.Str(required=False, load_from='HttpsStatusAbroad'), 
        ...
        'OriginProtocol': fields.Str(required=False, load_from='OriginProtocol'), 
...
class TaskInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'Type': fields.Str(required=False, load_from='Type'), # Deprecated, will be removed at 1.0
...
class HitRateInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'RequestHitRate': fields.Float(required=False, load_from='RequestHitRate'), 
...
class RequestInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'OriginRequest': fields.Float(required=False, load_from='OriginRequest'), 
...
class OriginConfSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'BackupOriginEnable': fields.Bool(required=False, load_from='BackupOriginEnable'), 
    
        'BackupOriginHost': fields.Str(required=False, load_from='BackupOriginHost'), 
    
        'BackupOriginIpList': fields.List(fields.Str()), 
    
        'OriginErrorCode': fields.Str(required=False, load_from='OriginErrorCode'), 
    
        'OriginErrorNum': fields.Int(required=False, load_from='OriginErrorNum'), 
    
        'OriginFollow301': fields.Int(required=False, load_from='OriginFollow301'), 
...
class DomainConfigInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'HttpsStatusAbroad': fields.Str(required=True, load_from='HttpsStatusAbroad'), 
