...
class UDDBClient(Client):
    ...
    def change_uddb_instance_name(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def change_uddb_slave_count(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def create_uddb_instance(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def delete_uddb_instance(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_uddb_instance(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_uddb_instance_price(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def describe_uddb_instance_upgrade_price(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def restart_uddb_instance(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def start_uddb_instance(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def stop_uddb_instance(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def upgrade_uddb_data_node(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
    ...
    def upgrade_uddb_instance(self, req: typing.Optional[dict] = None, **kwargs) -> dict:
