...
class DataNodeInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'LastTransTaskId': fields.Str(required=False, load_from='LastTransTaskId'), 
...
class DataSetUDDBSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataNodeDiskSpace': fields.Str(required=False, load_from='DataNodeDiskSpace'), 
    
        'DataNodeList': fields.List(DataNodeInfoSchema()), 
    
        'DataNodeMemory': fields.Str(required=False, load_from='DataNodeMemory'), 
    
        'DataNodeSlaveCount': fields.Str(required=False, load_from='DataNodeSlaveCount'), 
...
class PriceDetailInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataNodePrice': fields.Float(required=False, load_from='DataNodePrice'), 
    
        'DataNodeSlavePrice': fields.Float(required=False, load_from='DataNodeSlavePrice'), 
    
        'MiddlewarePrice': fields.Float(required=False, load_from='MiddlewarePrice'), 
