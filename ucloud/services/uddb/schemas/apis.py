...
class CreateUDDBInstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'DataNodeDiskSpace': fields.Int(required=True, dump_to='DataNodeDiskSpace'), 
    
        'DataNodeMemory': fields.Int(required=True, dump_to='DataNodeMemory'), 
    
        'DataNodeSlaveCount': fields.Int(required=False, dump_to='DataNodeSlaveCount'), 
...
class DescribeUDDBInstanceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.DataSetUDDBSchema(), required=False, load_from='DataSet'), 
...
class DescribeUDDBInstanceUpgradePriceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'DataNodeDiskSpace': fields.Int(required=False, dump_to='DataNodeDiskSpace'), 
