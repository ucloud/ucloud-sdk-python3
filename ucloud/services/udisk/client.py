...
class UDiskClient(Client):
    ...
    def rename_udisk(self, req: dict = None) -> dict:
        ...
        """
        req = apis.RenameUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("RenameUDisk", req)
    ...
    def restore_udisk(self, req: dict = None) -> dict:
        ...
        """
        req = apis.RestoreUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("RestoreUDisk", req)
    ...
    def attach_udisk(self, req: dict = None) -> dict:
        ...
        """
        req = apis.AttachUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("AttachUDisk", req)
    ...
    def clone_udisk(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CloneUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("CloneUDisk", req)
    ...
    def describe_udisk_upgrade_price(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeUDiskUpgradePriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUDiskUpgradePrice", req)
    ...
    def describe_udisk(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUDisk", req)
    ...
    def detach_udisk(self, req: dict = None) -> dict:
        ...
        :param Zone: (Required) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DetachUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("DetachUDisk", req)
    ...
    def set_udisk__udataark_mode(self, req: dict = None) -> dict:
        ...
        :param Zone: (Required) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.SetUDiskUDataArkModeRequestSchema().dumps(req or {})
        resp = self.invoke("SetUDiskUDataArkMode", req)
    ...
    def clone_udisk_snapshot(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CloneUDiskSnapshotRequestSchema().dumps(req or {})
        resp = self.invoke("CloneUDiskSnapshot", req)
    ...
    def create_udisk(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CreateUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("CreateUDisk", req)
    ...
    def create_udisk_snapshot(self, req: dict = None) -> dict:
        ...
        :param Quantity: (Optional) 购买时长 默认: 1
        """
        req = apis.CreateUDiskSnapshotRequestSchema().dumps(req or {})
        resp = self.invoke("CreateUDiskSnapshot", req)
    ...
    def describe_udisk_snapshot(self, req: dict = None) -> dict:
        ...
        :param Zone: (Optional) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DescribeUDiskSnapshotRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUDiskSnapshot", req)
    ...
    def resize_udisk(self, req: dict = None) -> dict:
        ...
        :param CouponId: (Optional) 使用的代金券id
        """
        req = apis.ResizeUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("ResizeUDisk", req)
    ...
    def delete_udisk(self, req: dict = None) -> dict:
        ...
        :param Zone: (Required) 可用区。参见 [可用区列表](../summary/regionlist.html)
        """
        req = apis.DeleteUDiskRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteUDisk", req)
    ...
    def delete_udisk_snapshot(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DeleteUDiskSnapshotRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteUDiskSnapshot", req)
    ...
    def describe_udisk_price(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeUDiskPriceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeUDiskPrice", req)
