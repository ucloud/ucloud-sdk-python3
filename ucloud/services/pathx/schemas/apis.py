...
class CreateGlobalSSHInstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'BandwidthPackage': fields.Int(required=False, dump_to='BandwidthPackage'), 
...
class CreateGlobalSSHInstanceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AcceleratingDomain': fields.Str(required=False, load_from='AcceleratingDomain'), 
    
        'InstanceId': fields.Str(required=True, load_from='InstanceId'), 
    
        'Message': fields.Str(required=False, load_from='Message'), # Deprecated, will be removed at 1.0
...
class CreateUGA3InstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'AccelerationArea': fields.Str(required=False, dump_to='AccelerationArea'), 
...
class CreateUPathResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UPathId': fields.Str(required=True, load_from='UPathId'), # Deprecated, will be removed at 1.0
...
class DescribeGlobalSSHAreaResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AreaSet': fields.List(models.GlobalSSHAreaSchema(), required=False, load_from='AreaSet'), 
...
class DescribeGlobalSSHInstanceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'InstanceSet': fields.List(models.GlobalSSHInfoSchema(), required=False, load_from='InstanceSet'), 
...
class DescribePathXLineConfigResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'LineSet': fields.List(models.UGAALineSchema(), required=False, load_from='LineSet'), 
...
class DescribePathXSSLResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.PathXSSLSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeUGA3AreaResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AreaSet': fields.List(models.ForwardAreaSchema(), required=False, load_from='AreaSet'), 
...
class DescribeUGA3InstanceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ForwardInstanceInfos': fields.List(models.ForwardInfoSchema(), required=False, load_from='ForwardInstanceInfos'), 
...
class DescribeUGA3OptimizationResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AccelerationInfos': fields.List(models.AccelerationInfoSchema(), required=False, load_from='AccelerationInfos'), 
...
class DescribeUGAInstanceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UGAList': fields.List(models.UGAAInfoSchema(), required=False, load_from='UGAList'), 
...
class DescribeUPathResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UPathSet': fields.List(models.UPathInfoSchema(), required=True, load_from='UPathSet'), 
...
class DescribeUPathTemplateResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.AlarmRulerSchema(), required=True, load_from='DataSet'), 
...
class GetUGA3PriceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'UGA3Price': fields.List(models.UGA3PriceSchema(), required=True, load_from='UGA3Price'), 
