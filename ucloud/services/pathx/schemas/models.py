...
class GlobalSSHInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'BandwidthPackage': fields.Int(required=False, load_from='BandwidthPackage'), 
...
class AccelerationAreaInfosSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AccelerationArea': fields.Str(required=True, load_from='AccelerationArea'), 
...
class ForwardInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AccelerationAreaName': fields.Str(required=True, load_from='AccelerationAreaName'), 
...
class NodeDelaysSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'LatencyInternet': fields.Float(required=True, load_from='LatencyInternet'), 
    
        'LatencyOptimization': fields.Float(required=True, load_from='LatencyOptimization'), 
    
        'Loss': fields.Float(required=True, load_from='Loss'), 
    
        'LossInternet': fields.Float(required=True, load_from='LossInternet'), 
    
        'LossOptimization': fields.Float(required=True, load_from='LossOptimization'), 
...
class AccelerationInfoSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AccelerationName': fields.Str(required=True, load_from='AccelerationName'), 
...
class AlarmRulerSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AlarmTemplateRuleId': fields.Int(required=True, load_from='AlarmTemplateRuleId'), 
...
class UGA3PriceSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'AccelerationBandwidthPrice': fields.Float(required=True, load_from='AccelerationBandwidthPrice'), 
    
        'AccelerationForwarderPrice': fields.Float(required=True, load_from='AccelerationForwarderPrice'), 
