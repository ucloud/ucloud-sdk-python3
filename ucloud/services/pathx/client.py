...
class PathXClient(Client):
    ...
    def delete_global_ssh_instance(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DeleteGlobalSSHInstanceRequestSchema().dumps(req or {})
        resp = self.invoke("DeleteGlobalSSHInstance", req)
    ...
    def describe_global_ssh_area(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeGlobalSSHAreaRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeGlobalSSHArea", req)
    ...
    def describe_global_ssh_instance(self, req: dict = None) -> dict:
        ...
        """
        req = apis.DescribeGlobalSSHInstanceRequestSchema().dumps(req or {})
        resp = self.invoke("DescribeGlobalSSHInstance", req)
    ...
    def modify_global_ssh_port(self, req: dict = None) -> dict:
        ...
        """
        req = apis.ModifyGlobalSSHPortRequestSchema().dumps(req or {})
        resp = self.invoke("ModifyGlobalSSHPort", req)
    ...
    def modify_global_ssh_remark(self, req: dict = None) -> dict:
        ...
        """
        req = apis.ModifyGlobalSSHRemarkRequestSchema().dumps(req or {})
        resp = self.invoke("ModifyGlobalSSHRemark", req)
    ...
    def create_global_ssh_instance(self, req: dict = None) -> dict:
        ...
        """
        req = apis.CreateGlobalSSHInstanceRequestSchema().dumps(req or {})
        resp = self.invoke("CreateGlobalSSHInstance", req)
