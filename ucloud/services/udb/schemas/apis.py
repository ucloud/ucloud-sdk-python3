...
class CreateMongoDBReplicaSetRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'InstanceType': fields.Str(required=False, dump_to='InstanceType'), # Deprecated, will be removed at 1.0
        ...
        'SSDType': fields.Str(required=False, dump_to='SSDType'), # Deprecated, will be removed at 1.0
    
        'SubnetId': fields.Str(required=False, dump_to='SubnetId'), 
    
        'UseSSD': fields.Bool(required=False, dump_to='UseSSD'), # Deprecated, will be removed at 1.0
...
class CreateUDBInstanceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'HAArch': fields.Str(required=False, dump_to='HAArch'), # Deprecated, will be removed at 1.0
        ...
        'UDBCId': fields.Str(required=False, dump_to='UDBCId'), # Deprecated, will be removed at 1.0
...
class CreateUDBSlaveRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'InstanceMode': fields.Str(required=False, dump_to='InstanceMode'), # Deprecated, will be removed at 1.0
    
        'InstanceType': fields.Str(required=False, dump_to='InstanceType'), # Deprecated, will be removed at 1.0
    
        'IsCreatePhysically': fields.Bool(required=False, dump_to='IsCreatePhysically'), 
...
class DescribeUDBBackupRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'BackupId': fields.Int(required=False, dump_to='BackupId'), # Deprecated, will be removed at 1.0
    
        'BackupType': fields.Int(required=False, dump_to='BackupType'), 
    
        'BeginTime': fields.Int(required=False, dump_to='BeginTime'), 
    
        'ClassType': fields.Str(required=False, dump_to='ClassType'), # Deprecated, will be removed at 1.0
...
class DescribeUDBBackupResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDBBackupSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeUDBInstanceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDBInstanceSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeUDBInstanceBinlogResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDBInstanceBinlogSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeUDBInstanceBinlogBackupStateResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'BackupSize': fields.Int(required=False, load_from='BackupSize'), # Deprecated, will be removed at 1.0
...
class DescribeUDBInstancePriceRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'UseSSD': fields.Str(required=False, dump_to='UseSSD'), # Deprecated, will be removed at 1.0
...
class DescribeUDBInstancePriceResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDBInstancePriceSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeUDBLogPackageResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.LogPackageDataSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeUDBParamGroupResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDBParamGroupSetSchema(), required=False, load_from='DataSet'), 
...
class DescribeUDBSplittingInfoResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDBRWSplittingSetSchema(), required=False, load_from='DataSet'), 
    
        'DelayThreshold': fields.Int(required=False, load_from='DelayThreshold'), 
...
class DescribeUDBTypeRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'CompatibleWithDBType': fields.Str(required=False, dump_to='CompatibleWithDBType'), 
...
class DescribeUDBTypeResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.UDBTypeSetSchema(), required=False, load_from='DataSet'), 
...
class GetUDBClientConnNumResponseSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'DataSet': fields.List(models.ConnNumMapSchema(), required=True, load_from='DataSet'), 
...
class UploadUDBParamGroupRequestSchema(schema.RequestSchema):
    ...
    fields = {
        ...
        'ParamGroupTypeId': fields.Int(required=False, dump_to='ParamGroupTypeId'), # Deprecated, will be removed at 1.0
