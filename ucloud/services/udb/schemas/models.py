...
class UDBBackupSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'ErrorInfo': fields.Str(required=False, load_from='ErrorInfo'), # Deprecated, will be removed at 1.0
...
class UDBInstanceSetSchema(schema.ResponseSchema):
    ...
    fields = {
        ...
        'CluserRole': fields.Str(required=False, load_from='CluserRole'), # Deprecated, will be removed at 1.0
